...
const ActionResultPage = ({
  ...
  return (
    <div className="bg-black min-h-[668px] text-white flex flex-col items-center justify-center relative px-4">
      <h1 className="text-4xl relative mb-6" style={{ fontFamily: "var(--font-br)" }}>
        {type}{" "}
        ...
        <img
          ...
          onClick={closeAction || (() => router.push("/marketplace"))}
        />
      </h1>

      {rarity && title && (
        <p className="text-xl mb-6 text-center">
          [{rarity} | {title}] {quantity}장 {type} {result === "성공" ? "에 성공했습니다!" : "에 실패했습니다."}
        </p>
      )}

      <button
        onClick={buttonAction || (() => router.push("/marketplace"))}
